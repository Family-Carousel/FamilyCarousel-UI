<template>
  <v-sheet color="transparent">
    <v-container class="py-6 py-lg-12 text-center">
      <h1 class="text-h4 text-sm-h3 text-md-h2 text-lg-h1 mt-md-6">
        Prototype your <span class="primary--text">web project</span>
      </h1>
      ...
      <v-img
        :src="require('@/assets/images/shot.png')"
        alt=""
        class="rounded elevation-3 mb-6"
      ></v-img>
    </v-container>
  </v-sheet>
</template>
